...
import (
	...
	"github.com/axodevelopment/demo-operators/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "211d461d.workshop.io",
	...
	if err := (&controller.PaychexReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "Paychex")
		os.Exit(1)
	}
